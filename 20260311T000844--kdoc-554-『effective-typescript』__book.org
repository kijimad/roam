...
:ID: 20260311T000844
:end:
#+title:      KDOC 554: 『Effective TypeScript』
#+date:       [2026-03-11 Wed 00:08]
#+filetags:   :book:
#+identifier: 20260311T000844

* CLOSE この文書のステータス
CLOSED: [2026-09-11 Fri 20:44]
:LOGBOOK:
CLOCK: [2026-06-02 Tue 00:00]--[2026-06-02 Tue 00:25] =>  0:25
CLOCK: [2026-05-30 Sat 19:46]--[2026-05-30 Sat 20:11] =>  0:25
CLOCK: [2026-05-18 Mon 23:40]--[2026-05-19 Tue 00:05] =>  0:25
CLOCK: [2026-05-18 Mon 22:49]--[2026-05-18 Mon 23:14] =>  0:25
CLOCK: [2026-05-18 Mon 22:17]--[2026-05-18 Mon 22:42] =>  0:25
CLOCK: [2026-05-17 Sun 23:31]--[2026-05-17 Sun 23:56] =>  0:25
CLOCK: [2026-05-17 Sun 21:08]--[2026-05-17 Sun 21:33] =>  0:25
CLOCK: [2026-05-17 Sun 20:07]--[2026-05-17 Sun 20:32] =>  0:25
CLOCK: [2026-05-17 Sun 19:32]--[2026-05-17 Sun 19:57] =>  0:25
CLOCK: [2026-05-17 Sun 01:06]--[2026-05-17 Sun 01:31] =>  0:25
CLOCK: [2026-05-17 Sun 00:17]--[2026-05-17 Sun 00:42] =>  0:25
:END:
- 作成
  - [X] 2026-09-11 貴島
- レビュー
...
『Effective TypeScript』は、TypeScriptを解説する本である。
...
#+caption: 空の配列の型は、異なる要素を追加することで大きくできる(p131)
#+begin_src twoslash
  const result = [];
  //    ^?
  result.push('a');
...
#+RESULTS:
#+begin_src
const result: any[] (line 1)
const result: string[] (line 3)
const result: (string | number)[] (line 5)
#+end_src

- TypeScriptによって拒否されたPromiseによって投げられる例外は型をもたない(p140)
...
#+caption: async関数からPromiseを返してもラップされない(p143)
#+begin_src twoslash
...
#+RESULTS:
#+begin_src
const jsonPromise: Promise<any> (line 4)
function getJSON(url: string): Promise<any> (line 6)
#+end_src

- 有効な状態のみ表現する型を作る(p150)
- 入力は寛容に、出力は厳密に型を設計する(p156)
- 完全にnullか、完全に非nullか、にすると人間や型チェッカーにとってコードが明確になる(p163)
- 扱っているドメインの用語を再利用する。長い期間をかけて洗練されたものが多い。気候区分だとケッペンなど(p193)
- any 型の性質
  1. すべての型は any 型に代入可能である
  2. any 型はすべての型に代入可能である
- unknown型は1番目の性質しか持たない。never型は逆で2番目の性質しか持たない
  - unknown型の値のプロパティにアクセスしようとするとエラーになる。unknown型ではほとんど何もできない。なので型アサーションが必要になる
- npm の type-coverage で型カバレッジを計測する
