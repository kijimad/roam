...
- 類推: [[id:20250603T215002][KDOC 381: 識別子の先頭に数値が使えないのは区別がつかなくなるから]]。識別子制限の理由の1つ
- 参照: [[https://en.wikipedia.org/wiki/Unicode_character_property][Unicode character property - Wikipedia]]。カテゴリ表を参考にした
- 参照: [[https://go.dev/ref/spec#letter][The Go Programming Language Specification]]。Goの言語仕様書
